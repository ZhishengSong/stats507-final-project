"""BitFit fine-tuning workflow for ViLT."""
...
from models.vilt_bitfit import build_vilt_bitfit_model
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="BitFit (bias-only) fine-tuning for ViLT.")
    ...
    parser.add_argument("--output_dir", type=str, default="checkpoints/vilt_bitfit")
    parser.add_argument("--best_checkpoint_name", default="best.pt")
    parser.add_argument("--resume_checkpoint", default=None)
    parser.add_argument("--log_file", default="logs/training/vilt_bitfit.log")
    parser.add_argument("--seed", type=int, default=42)
    parser.add_argument("--no_cuda", action="store_true")
    parser.add_argument("--use_amp", action="store_true")
    parser.add_argument("--do_test", action="store_true")
    parser.add_argument("--save_predictions", action="store_true")
    parser.add_argument("--predictions_dir", default="logs/predictions/vilt_bitfit")
    parser.add_argument("--vilt_model_name", default="dandelin/vilt-b32-mlm")
    parser.add_argument(
        "--bias_keywords",
        nargs="+",
        default=["bias"],
        help="Substring(s) used to identify bias parameters to tune.",
    )
    parser.add_argument(
